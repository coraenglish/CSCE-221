...
int main ()
{
  ...
  cout << "Insert 10 nodes in list 2 using insert after" << endl;
  for (int i=0; i < 20; i+=2) {
    dll2.insert_after(*dll2[i], i);
  }

  cout << "list: " << dll2 << endl << endl;


  cout << "Insert 10 nodes in list 3 using insert before" << endl;
  for (int i=1; i < 19; i+=2) {
    dll3.insert_before(*dll3[i], i);
  }
